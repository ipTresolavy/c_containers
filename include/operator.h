...
// .c) maybe generalize the CONT_PRIV_PREFIX macro doc: explain what the project
// is (a bunch of macros) and usage. Begin with end result and explain what user
// has to do to use it. Also say it is type-safe
